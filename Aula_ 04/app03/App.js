...
{
  id: '2', titulo: 'HTML e CSS', subtitulo: 'HTML 5 e suas novidades', imagem:
    'https://placehold.co/100x100', descricao: 'Curso sobre HTML5 e CSS.'
},
{
...
{
  id: '6', titulo: 'React Native', subtitulo: 'Desbravando conteúdo', imagem:
    'https://placehold.co/100x100', descricao: 'Curso de React Native.'
},];

export default function App() {
  const handlePress = (item) => { Alert.alert(item.titulo, item.descricao); };
